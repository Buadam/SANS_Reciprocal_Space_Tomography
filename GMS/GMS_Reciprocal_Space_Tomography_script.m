...
% This part is enough for the final plots
%==========================================================================
load('Cartesian_mesh_Lab.mat','Xc','Yc','Zc');
...
set(gcf,'Units','centimeters');
set(gcf, 'Position', Pos);
export_fig('Figures/GMS_111_symm.png','-png');
...
%axis square
grid on
export_fig('Figures/GMS_001_symm.png');
...
%axis square
grid on
export_fig('Figures/GMS_110_symm.png','-png');
...
%axis square
grid on
export_fig('Figures/GMS_112_symm.png','-png');
%==========================================================================
